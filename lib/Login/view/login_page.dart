...
import 'package:todo/Login/bloc/autincation_bloc.dart';
...
//1
  final _authBloc = AutincationBloc();
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: BlocListener<AutincationBloc, AutincationState>(
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      TextButton(
                        onPressed: () =>
                            Navigator.of(context).pushNamed('Siginup'),
